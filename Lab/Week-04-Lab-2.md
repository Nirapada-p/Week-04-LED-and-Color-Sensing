...
<img width="571" height="403" alt="G1" src="https://github.com/user-attachments/assets/55c626aa-4053-496a-a9a8-50106bcdcf14" />
...
3. **คำถามนำเพื่อการวิเคราะห์เชิงระบบ (Critical Thinking):**
   ...
   ```
   ค่า ADC ในช่วงแซมเปิ้ลแรกมีค่าพุ่งขึ้นสูง แซมเปิ้ลที่ 2 เป็นต้นมาค่า ADC ก็ค่อยๆล่วงลงมาจนเหลือ 0 ในช่วงแซมเปิ้ลท้ายๆ
   ```
    - สัญญาณไฟฟ้าเข้าสู่ความนิ่ง (Settling) ที่แซมเปิ้ลใด หรือใช้เวลากี่มิลลิวินาที?
     ```
    Color B นิ่งที่ แซมเปิ้ลที่ 13 ประมาณ 130 ms
    Color R นิ่งที่ แซมเปิ้ลที่ 17 ประมาณ 170 ms
    Color G นิ่งช้าสุดที่ แซมเปิ้ลที่ 18 ประมาณ 180 ms
     ```    
...
```
1.ข้อจำกัดของรอยต่อ PN บน LED ภาครับ
    ความลาดเอียงของกราฟเกิดจาก รอยต่อ PN มีความจุไฟฟ้าในตัวเอง จึงต้องใช้เวลาเล็กน้อยในการเก็บและปล่อยประจุ ทำให้แรงดันเปลี่ยนแปลงไม่ทันที แต่ค่อย ๆ เปลี่ยน
2.ข้อจำกัดของตัวเก็บประจุสุ่มสัญญาณภายในไมโครคอนโทรลเลอร์
    ความลาดเอียงของกราฟเกิดในช่วงแรกเกิดจาก ตัวเก็บประจุในวงจร ADC ต้องใช้เวลาเก็บตัวอย่างแรงดันก่อนแปลงเป็นข้อมูลดิจิทัล จึงทำให้ค่าที่อ่านได้เปลี่ยนแปลงอย่างค่อยเป็นค่อยไป ไม่ได้เปลี่ยนทันทีตามสัญญาณจริง
```
...
```
ตัดข้อมูลช่วงที่สัญญาณกำลังเปลี่ยนแปลงออกแล้วเอาเฉพาะค่าที่เข้าสู่ช่วงคงที่มาหาค่าเฉลี่ย เพราะเป็นช่วงที่แรงดันมีความใกล้เคียงค่าจริงที่สุด ในโปรแกรมมเขียนหน่วงเวลาหลังจากสลับสถานะ LED ประมาณ 50–200 µs เพื่อให้สัญญาณ Settling เสร็จก่อน
```
