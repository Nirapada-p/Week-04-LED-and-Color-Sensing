...
1. **การคัดกรองข้อมูลคุณภาพ (Data Selection Report):**
   ...
   <img width="486" height="375" alt="image (2)" src="https://github.com/user-attachments/assets/0fb7768d-7ce1-4fc9-ab51-fc531c9fff16" />
...
```
หลังจากใช้ Trimmed Mean ค่าความผันผวน(SD) ลดลงเมื่อเทียบกับใบงานที่ 2 เนื่องจากวิธีนี้ตัดค่าที่สูงและต่ำผิดปกติออกก่อนคำนวณค่าเฉลี่ย ทำให้ผลลัพธ์มีความนิ่งและเสถียรมากขึ้น ลดสัญญาณรบกวนและค่าที่ผิดพลาดชั่วขณะเลยได้ค่าที่ใกล้เคียงกับแรงดันจริง
```
...
```
    การใช้แรงดันทางกายภาพมีความสำคัญกว่า เพราะเป็นค่าที่อธิบายสภาพจริงของโลกกายภาพและสามารถเปรียบเทียบกันได้แม้ใช้อุปกรณ์ต่างรุ่นหรือตั้งค่าADCต่างกัน ส่วนค่าดิจิทัลดิบ 0–4095 เป็นเพียงตัวเลขในโลกดิจิทัลที่ขึ้นอยู่กับความละเอียดของ ADC และแรงดันอ้างอิง จึงไม่สามารถนำไปเปรียบเทียบหรือกำหนดเกณฑ์ได้โดยตรง
    ตามแนวคิดสองโลกที่แตกต่าง เซนเซอร์ทำหน้าที่แปลงข้อมูลจาก โลกกายภาพ แสงเป็นแรงดันไฟฟ้าแล้ว ADC จึงแปลงแรงดันให้เป็นข้อมูลดิจิทัลเพื่อให้ไมโครคอนโทรลเลอร์ประมวลผล ดังนั้น การแปลงกลับมาเป็นหน่วย mV จะช่วยให้ข้อมูลมีความหมายทางวิศวกรรม สื่อสารและนำไปใช้ได้อย่างแม่นยำและสอดคล้องกับสภาพจริงมากกว่าการใช้ค่าดิจิทัลดิบแค่อย่างเดียว
```
